...
module Carbon
  # Renders a Carbon Design System Toast Notification.
  #
  # @example Basic usage
  #   render Carbon::ToastNotificationComponent.new(title: "Saved", kind: :success)
  #
  # @see https://carbondesignsystem.com/components/notification/usage/
  class ToastNotificationComponent < BaseComponent
    ...
    # @return [String, nil] notification caption
    attr_reader :caption
    # @return [Boolean] whether to hide the close button
    attr_reader :hide_close_button
    # @return [Integer, nil] auto-dismiss timeout in milliseconds
    attr_reader :timeout
    ...
    # @param caption [String, nil] notification caption
    # @param hide_close_button [Boolean] hides the close button
    # @param timeout [Integer, nil] auto-dismiss timeout in milliseconds
    ...
    def css_classes
      classes = ['cds--toast-notification', "cds--toast-notification--#{KIND_CSS[@kind]}"]
      classes << 'cds--toast-notification--low-contrast' if @low_contrast
    ...
    def html_attributes
      ...
      attrs[:data] ||= {}
      attrs[:data][:controller] = 'carbon--toast-notification'
      attrs[:data][:'carbon--toast-notification-timeout-value'] = @timeout if @timeout&.positive?
      attrs
    end
    ...
    def info_icon
      '<svg class="cds--toast-notification__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" ' \
